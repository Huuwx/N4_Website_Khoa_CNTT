...
export default function LienHeDetail() {
  ...
  const handleUpdateStatus = async () => {
    try {
      await api.put(`/yeu-cau-lien-he/${request.id}`, { trangThai: status });
    ...
    <div className="container">
      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 w-full max-w-lg">
          ...
          <div className="flex justify-center gap-4 mt-4">
            <button type="primary" onClick={handleUpdateStatus} className="bg-red-600 text-white px-6 py-2 rounded-full hover:bg-red-800 transition">
              XÁC NHẬN
            </button>
